...
<body>
    ...
    <div class="main-btn">
    <button class="btn left-btn">Top Rated</button>
    ...
    <div class="card-grid">
        <?php 
            $DB = new Database();
            $info = $DB -> read("SELECT Mts_id FROM Movies_Tvshow where Rel_date < 2023 Order by Rating desc");
            $card = $DB -> read("SELECT * FROM Movies_Tvshow where Rel_date < 2023 Order by Rating desc");
            $i = 0;
