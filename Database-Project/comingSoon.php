...
<body>
    ...
    <button class="btn left-btn">Coming Soon</button>
    </div>
...
<div class="card-grid">
        <?php 
            $DB = new Database();
            $info = $DB -> read("SELECT Mts_id FROM Movies_Tvshow where Rel_date > 2022");
            $card = $DB -> read("SELECT * FROM Movies_Tvshow where Rel_date > 2022 Order by Rating desc");
            $i = 0;
            ...
            ?> 
                ...
                <div class="card"> 
                        ...
                        <div class="card-body">
                            <p><span class = "rating-c"><b>Rating</b>: N/A
